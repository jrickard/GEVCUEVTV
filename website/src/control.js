...
function loadPage(pageId) {
	...
	xmlhttp.onreadystatechange = function() {
		if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
			...
			if (pageId == 'dashboard') {
				var coolOn = document.getElementById('coolOn');
				var coolOff = document.getElementById('coolOff');
				//updateTemperatureInverterGaugeHighlights(coolOn.value, coolOff.value);
...
function generateRangeControls() {
	...
	addRangeControl("coolOn", 0, 120);
	addRangeControl("coolOff", 0, 120);
